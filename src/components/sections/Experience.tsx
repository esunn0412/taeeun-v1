        ...
        {ExperienceData.map((exp, index) => (
          ...
          >
            <div className="relative flex flex-col items-center">
              <div className="size-6 rounded-full bg-[var(--primary)] group-hover:bg-[var(--highlight)] transition-all duration-200 flex items-center justify-center z-10">
                  ...
                  <div className="flex flex-wrap gap-6 mt-4">
                    {exp.links.map((link, index) => (
                      <a
                        ...
                        className="text-[var(--description)] hover:text-[var(--highlight)] transition-all duration-200 flex items-center"
                      >
